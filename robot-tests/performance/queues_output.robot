*** Comments ***
Copyright (c) 2020-2024, Nokia Solutions and Networks
All rights reserved.
SPDX-License-Identifier: BSD-3-Clause


*** Settings ***
Documentation    Queues Output -c ${CORE_MASK} -${APPLICATION_MODE}
...
*** Test Cases ***
Test Queues Output
    [Documentation]    queues_output -c ${CORE_MASK} -${APPLICATION_MODE}
